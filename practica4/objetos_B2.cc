...
void _triangulos3D::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, _vertex4f ambiente_difusa, _vertex4f especular, float brillo)
{
switch (modo){
	...
	case SOLID_ILLUMINATED_FLAT:draw_iluminacion_plana(ambiente_difusa, especular, brillo);break;
   case SOLID_ILLUMINATED_GOURAUD:draw_iluminacion_suave(ambiente_difusa, especular, brillo);break;
	}
}
...
void 	_triangulos3D::draw_iluminacion_plana(_vertex4f ambiente_difusa, _vertex4f especular, float brillo){
...
void _triangulos3D::draw_iluminacion_suave(_vertex4f ambiente_difusa, _vertex4f especular, float brillo){
	if (b_normales_caras==false) calcular_normales_caras();
...
void _pantalla::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor,_vertex4f ambiente_difusa, _vertex4f especular, float brillo)
{
glPushMatrix();
//glScalef(1.0,0.22,0.95);
pan.draw(modo, r1, g1, b1, r2, g2, b2, grosor, ambiente_difusa, especular,  brillo);
glPopMatrix();
}
...
void _brazo::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, _vertex4f ambiente_difusa, _vertex4f especular, float brillo)
{
glPushMatrix();
//glScalef(1.0,0.22,0.95);
br.draw(modo, r1, g1, b1, r2, g2, b2, grosor, ambiente_difusa, especular, brillo);
glPopMatrix();
}
...
void _base::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, _vertex4f ambiente_difusa, _vertex4f especular, float brillo)
{
glPushMatrix();
//glScalef(1.0,0.22,0.95);
bas.draw(modo, r1, g1, b1, r2, g2, b2, grosor, ambiente_difusa, especular, brillo);
glPopMatrix();
}
...
glPushMatrix();
	...
	base.draw(modo, r1, g1, b1, r2, g2, b2, grosor, ambiente_difusa, especular, brillo);
	glTranslatef(0.0,base.altura,0.0);
	glRotatef(giro_brazo_inf,0,0,1);
	brazo_inf.draw(modo, r1, g1, b1, r2, g2, b2, grosor, ambiente_difusa, especular, brillo);
	glPushMatrix();
		glTranslatef(0.0,brazo_inf.altura,0.0);
		glRotatef(giro_brazo_sup,0,0,1);
		brazo_sup.draw(modo, r1, g1, b1, r2, g2, b2, grosor, ambiente_difusa, especular, brillo);
		glPushMatrix();
...
void _luz::encender(GLenum indice, float x, float y, float z, int alpha_e, int beta_e, float r, float g, float b)
{
    glEnable(indice);
