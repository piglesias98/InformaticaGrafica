...
//ILUMINACIÓN
void 	draw_iluminacion_plana(_vertex4f ambiente_difusa, _vertex4f especular, float brillo);
void 	draw_iluminacion_suave(_vertex4f ambiente_difusa, _vertex4f especular, float brillo);

void 	draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, _vertex4f ambiente_difusa, _vertex4f especular, float brillo);
...
public:
	...
	void encender(GLenum indice, float x, float y, float z, int alpha_e, int beta_e, float r, float g, float b);	
};
